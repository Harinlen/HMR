...
def parse_arguments():
    ...
    parser.add_argument('-1', '--r1', dest='r1', type=str, help='R1 reads (.fastq.gz)')
    parser.add_argument('-2', '--r2', dest='r2', type=str, help='R2 reads (.fastq.gz)')
    parser.add_argument('-b', '--bam', dest='bam', type=str, help='Reference genome (.fasta)')
