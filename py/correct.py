...
def parse_arguments():
    ...
    parser.add_argument("-q", "--mapq", dest='mapq', type=int, default=1, help="MAPQ of mapping lower bound, default is 1")
    parser.add_argument("-w", "--wide", dest='wide', type=int, default=25000, help="Resolution for first pass search of mismatches, default is 25000 bp")
    parser.add_argument("-n", "--narrow", dest='narrow', type=int, default=1000, help="Resolution for the precise mismatch localizaton, n<w default is 1000 bp")
    parser.add_argument("-d", "--depletion", dest='depletion', type=int, default=100000, help="The size of the region to aggregate the depletion score in the wide path, d >= 2*w, default is 100000 bp")
